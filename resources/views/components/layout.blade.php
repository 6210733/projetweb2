...
<body>
    ...
    {{-- HEADER --}}
    <header class="bg-noir w-full opacity-[.80] ">
                ...
                @else
                    ...
                    <button class="mr-8 p-2 border-mauve border-2 rounded drop-shadow-3xl lien-header">
                        ...
                        <a href="{{ route('connexion.create') }}">
                            <p class="text-gray-400 font-quicksand text-xl lien-header">Mon compte</p>
                        </a>
        ...
        {{-- LIENS --}}
        <div id="app" class="w-full flex justify-evenly bg-noir text-white font-quicksand text-lg font-bold tracking-wider">
    ...
    {{-- FOOTER --}}
    <footer class="flex flex-col items-center w-full pt-16 pb-16 bg-noir font-quicksand opacity-[.67]">
        ...
        <div class="text-center mt-10 text-white mb-10">
            ...
            <h2 class="font-technorace text-2xl">INSCRIVEZ-VOUS À L'INFOLETTRE !</h2>

            <p class="font-quicksand mb-3">Restez à jour et soyez au courant des événements à venir</p>
        ...
        <div class="flex justify-around w-full mt-10 mb-10 text-white font-quicksand text-xl lien-footer">
            ...
            <div class="flex flex-col">
                <h3 class="text-mauve font-technorace text-xl lien-h3-footer"><a
